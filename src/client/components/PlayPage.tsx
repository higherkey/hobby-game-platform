...
export const PlayPage: React.FC<PlayPageProps> = ({
  ...
  return (
    <div className="play-page-container">
      ...
      {/* Host Room Modal */}
      {showHostModal && (
        <div className="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="host-modal-title">
          <div className="modal-card">
            <div className="modal-header">
              <h2 id="host-modal-title" className="modal-title">
                Host an Online Room
              </h2>
              <button
                type="button"
      ...
      {showLocalModal && (
        <div className="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="local-modal-title">
          <div className="modal-card">
            <div className="modal-header">
              <h2 id="local-modal-title" className="modal-title">
